...
//	  }
  ...
  private static Collection<BarcodeFormat> parseDecodeFormats(Iterable<String> scanFormats,
    ...
    if (decodeMode != null) {
      if (ScanIntent.Scan.PRODUCT_MODE.equals(decodeMode)) {
        return PRODUCT_FORMATS;
      }
      if (ScanIntent.Scan.QR_CODE_MODE.equals(decodeMode)) {
        return QR_CODE_FORMATS;
      }
      if (ScanIntent.Scan.DATA_MATRIX_MODE.equals(decodeMode)) {
        return DATA_MATRIX_FORMATS;
      }
      if (ScanIntent.Scan.ONE_D_MODE.equals(decodeMode)) {
