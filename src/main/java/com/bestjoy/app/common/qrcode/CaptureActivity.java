...
import com.bestjoy.app.common.qrcode.result.ResultButtonListener;
...
public class CaptureActivity extends Activity implements SurfaceHolder.Callback{
  ...
  protected ToggleButton status_view_flashlight;
  ...
  protected BeepAndVibrate media;
...
//  private boolean isEnterpriseCard = false;
  ...
  protected boolean mScanTask= false;
  ...
  public void drawViewfinder() {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
	    ...
	    if (requestCode == HISTORY_REQUEST_CODE) {
	        int itemNumber = data.getIntExtra(ScanIntent.History.ITEM_NUMBER, -1);
	        if (itemNumber >= 0) {
	...
	protected void onSaveInstanceState(Bundle outState) {
		outState.putBoolean(EXTRA_SCAN_TASK, false);
		super.onSaveInstanceState(outState);
	}
    
    public static void startActivity(Context context, boolean scanTask) {
        context.startActivity(createIntent(context, scanTask));
     }
  public static Intent createIntent(Context context, boolean scanTask) {
    Intent scanIntent = new Intent(context.getPackageName() + ".ACTION_SCAN");
