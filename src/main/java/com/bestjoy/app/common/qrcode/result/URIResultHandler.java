...
import com.bestjoy.app.common.qrcode.ParsedResultTypeAnnotation;
import com.bestjoy.app.common.qrcode.ScanIntent;
 ...
 */
@ParsedResultTypeAnnotation(parsedResultTypeName = "URI")
...
//    	BrowserActivity.startActivity(activity, uri, null);
        ScanIntent.openURL(activity, uri);
        break;
      case 2:
        shareByEmail(uri);
        break;
